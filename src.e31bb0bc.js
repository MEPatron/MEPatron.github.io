...
//     categories = new Set(Object.values(succursales).map((d) => d.type))
// }
...
function init() {
  ...
  svg.append("g").attr("transform", "translate(" + dims.left + "," + 0 + ")").attr("width", dims.width).attr("height", dims.height + dims.bottom * 2).attr("id", "bubbleArea"); // clip path
  ...
  var maxRange = dims.width * dims.height / 100000;
...
function redraw() {
  ...
  gx.transition().duration(ANIMATION_DURATION).call(xAxis, currentXScale);
...
function findInfo(d, sankeyParameters, firstCategories) {
  ...
  if (sankeyParameters.regionFilter == "all" && sankeyParameters.branchFilter == "all") {
    ...
    succName = sankeyParameters.branchFilter == "all" ? sankeyParameters.regionFilter : sankeyParameters.branchFilter;

    if (firstCategories.has(d.name)) {
      succData = sankeyParameters.data.filter(function (e) {
        return (e.region == succName || e.succ_name == succName) && e.source == d.name;
      });
      succData.forEach(function (f) {
      ...
      succData = sankeyParameters.data.find(function (e) {
        return (e.region == succName || e.succ_name == succName) && e.target == d.name;
      });
      succQuantity = succData ? succData.value : 0;
    }
  }
...
},{"./preprocess.js":"scripts/sankey/preprocess.js","./helper.js":"scripts/sankey/helper.js","./viz.js":"scripts/sankey/viz.js","./panel.js":"scripts/sankey/panel.js"}],"scripts/map/viz.js":[function(require,module,exports) {
"use strict";
